...
import 'RequestsPageAdmin.dart';

// The RequestsPageAdminWithResponse class represents the page for handling and displaying admin requests with responses.
class RequestsPageAdminWithResponse extends StatefulWidget {
  const RequestsPageAdminWithResponse({Key? key}) : super(key: key);

  @override
  _RequestsPageAdminWithResponseState createState() =>
      _RequestsPageAdminWithResponseState();
}

class _RequestsPageAdminWithResponseState
    extends State<RequestsPageAdminWithResponse> {
...
// Asynchronous method to fetch requests with responses from Firestore.
  Future<void> fetchRequests() async {
    final QuerySnapshot snapshot = await FirebaseFirestore.instance
        .collection('Requests')
        .where('Response', isNotEqualTo: '')
        .get();
    setState(() {
...
// Build method constructs the UI of the RequestsPageAdminWithResponse.
  @override
              ...
              children: [
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Color.fromRGBO(0, 167, 157, 0.99),
                  ),
                  child: Text(
                    "التفاصيل",
                    style: TextStyle(
